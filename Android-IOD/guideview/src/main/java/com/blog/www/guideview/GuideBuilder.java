...
public class GuideBuilder {
  ...
  /**
   * 设置目标view with offset
   */
  public GuideBuilder setTargetView(View v,int offsetX, int offsetY) {
    if (mBuilt) {
      throw new BuildException("Already created. rebuild a new one.");
    } else if (v == null) {
      throw new BuildException("Illegal view.");
    ...
    mConfiguration.mTargetView = v;
    mConfiguration.viewOffsetX = offsetX;
    mConfiguration.viewOffsetY = offsetY;
    return this;
  }
  ...
  public GuideBuilder addComponent(Component component) {
    ...
    Log.i("TG","mComponents.length="+mComponents.size());
    return this;
  }
